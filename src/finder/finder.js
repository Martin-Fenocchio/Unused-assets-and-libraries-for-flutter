...
class FinderLogic {
    constructor() {
        this.findDependencies = () => __awaiter(this, void 0, void 0, function* () {
            ...
            const filesPath = yield filesLogic.get(process.env.projectRootPath);
            yield Promise.all(dependenciesLogic.get().map((dependency) => __awaiter(this, void 0, void 0, function* () {
